...
Oleellinen muutoksen vaikuttava tekijä oli organisaation muut toiminnot joiden
kanssa ketterät ohjelmistokehitystiimit joutuvat kommunikoimaan.
...
ketterää kehitystä varten [S4, S6, S19, S23, S30]. Konsultteja käytettiin myös
kouluttamaan organisaation sisäisiä ketterän kehityksen valmentajia [S4, S28]. 
...
tekijänä ketterien menetelmien soveltamisessa. Myös Moore [S23] raportoi
merkittävästä panostuksesta testaukseen sekä jatkyvan yhdentämisen työkaluihin.
