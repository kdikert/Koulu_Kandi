...
\subsection{Haasteet ketterien menetelmien käyttöönotossa}
...
Kehittäjät ovat keskeisessä roolissa ketterissä malleissa. Muutoksen myötä
heidän on omaksuttava uusia työtapoja, mikä saattaa aiheuttaa muutosvastarintaa.
Syitä muutosvastarintaan voivat olla pelko omien taitojen riittämättömyydestä
uudessa ympäristössä tai kateuden tunne työtovereiden uusista tehtävistä
\citeppri{Boehm2005}. Mikäli organisaatiossa on vahva tausta
suunnitelmavetoisesta kehityksestä saattaa osaaminen olla kapea-alaista.
Ketterien menetelminen vaatiessa enemmän yleisiä taitoja saattaa aikaisempi
erikoistuminen muodostua ongelmaksi \citeppri{Nerur2005}.
Ketterien menetelmien yhteydessä on suositeltu keskivertoa parempien
kehittäjen käyttämistä \citeppri{Boehm2002}. Pelkästään huippukehittäjien
käyttäminen ei ole välttämätöntä, mutta heikoimpien suoriutujien
mukanaolo on haitallista ketterässä kehityksessä \citeppri{Nerur2005,Boehm2005}.
Keskeinen ominaisuus jota kehittäjien tulisi osoittaa ketterissä malleissa
on itseohjautuvuus \citeppri{Misra2009}.

Myös liiketoiminnan prosesseja joudutaan sopeuttamaan ketteriin menetelmiin.
Tuotannon ja suunnittelun tulisi etääntyä elinkaariajattelusta ja painottaa
iteratiivista ja toiminnallisuuksiin keskittyvää mallia \citeppri{Nerur2005}.
Ongelmana on että perinteisissä malleissa on annettu pitkän aikavälin
suunnitelmia ja tehty sitoomuksia. Ketterät menetelmät perustuvat kuitenkin
nopeiden muutosten mahdollistamiseen. Tämän takia myös organisaation johdon on
asennoiduttava hyväksymään muutoksia \citeppri{Misra2009}. Perinteisesti
liiketoimintaa on ojhattu pitkän tähtäimen suunnittelulla, mutta ketterät
menetelmät painottavat että merkityksellistä suunnittelua voi tehdä vain
lähitulevaisuuteen \citeppri{Boehm2005}. Johdon on myös hyväksyttävä että
kehitystyötä ei kannata pyrkiä hallitsemaan yksityiskohtaisella tasolla, vaan
sallia kevyemmät raportointikäytännöt \citeppri{Cohn2003}.
...
Ketterien menetelmien käyttöönotto suurissa organisaatioissa on ongelmallista
