...
niin kutsutulle perinteiselle kehitykselle.

Tiukasti suunnitelmavetoinnen kehitys ei tuota parasta lopputulosta, vaan
asiakkaan saavuttama hyöty tulisi olla tuotekehitystä ohjaava asia. Niin
kutsutut ohjelmistokehityksen perinteiset mallit pyrkivät vähentämään muutoksia
tuotteen kehityksessä, ja tulkitsevat muutoksia virheinä. Nykyään tuotteen
mukautumiskyky kehityskaaren aikana on kuitenkin kriittinen ominaisuus. Ketterät
menetelmät on kehitetty vastauksena perinteisen kehityksen muutosta vastustavaan
malliin. Muutoksen omaksuminen kehityksessä, korkean laadun tavoitteleminen ensi
askelista alkaen, sekä ihmiskeskeisyys ovat ketterien menetelmien keskeisiä
teemoja.
\citeppri{Highsmith2001}

Ketterää kehitystä on sekä kritisoitu että puollettu...
\citeppri{Boehm2002}

Vastaa ennalta arvaamattoman maailman haasteisiin. Tutkimuks on osoittanut että
sekä kehittäjät että asiakkaat ovat olleet tyytyväisempiä. On kuitenkin olemassa
todisteita siitä, että ketterät menetelmät eivät välttämättä sovellu suuriin
hankkeisiin.
\citeppri{Dyba2009}

Yleisiä ketterän kehityksen menetelmiä ovat nykyään Scrum ja Extreme Programming
(XP) \citeppri{Dyba2009}. Scrum-menetelmä \citeppri{Schwaber2002}. XP-menetelmä
\citeppri{Beck1999}
