...
esitellään yhteenveto tutkimuksista joita tarkasteltiin. Tämän jälkeen
esitellään tutkimuskysymyksiin liittyvät oleellisimmat havainnot.
...
käyttämistä. Muutosta oli tyypillisesti toteutettu 1 tai 2 vuotta kun siitä oli
raportoitu. Suurimmassa osasta tapauksia muutos katsottiin edelleen jatkuvan
raportin kirjoitusajankohtana.
